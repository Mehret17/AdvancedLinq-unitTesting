...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(s => s.Students.Count == 5);
            Assert.IsTrue(doAll); //<-- change false to doAll
        }
        ...
        {
            var doAll = PracticeData.All(P => P.PrimaryInstructor.Birthday.Year >=1980 && P.PrimaryInstructor.Birthday.Year < 1990);
