...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_First
    {
       ...
       */
        ...
        {
            var ActualCohort = PracticeData.First(I => I.PrimaryInstructor.FirstName.Contains("Kate"));
        ...
        {
            var ActualCohort = PracticeData.First(c => c.FullTime == true && c.PrimaryInstructor.Birthday > DateTime.Now);
        ...
        {
            var ActualCohort = PracticeData.FirstOrDefault(c => c.PrimaryInstructor.FirstName.Contains("Zelda"));/*FILL IN LINQ EXPRESSION*/;
